    ...
    var data = {
        "resource": {
            ...
            "tags": [{
                ...
                "priority": 19,
                "vtp_rules": ["list", "themeforest\\.net", "codecanyon\\.net", "audiojungle\\.net", "videohive\\.net", "3docean\\.net", "graphicriver\\.net", "photodune\\.net"],
                "tag_id": 10
            }, {
                "function": "__ogt_referral_exclusion",
                "priority": 9,
                "vtp_includeConditions": ["list", "paypal\\.com", "skrill\\.com", "accounts\\.google\\.com", "appleid\\.apple\\.com", "envato\\.okta\\.com", "themeforest\\.net", "codecanyon\\.net"],
                "tag_id": 12
            }, {
                "function": "__ogt_dma",
                "priority": 9,
                ...
                "priority": 2,
                "vtp_conversionRules": ["list", ["map", "matchingRules", "{\"type\":5,\"args\":[{\"stringValue\":\"purchase\"},{\"contextValue\":{\"namespaceType\":1,\"keyParts\":[\"eventName\"]}}]}"], ["map", "matchingRules", "{\"type\":5,\"args\":[{\"stringValue\":\"conversion_event_purchase\"},{\"contextValue\":{\"namespaceType\":1,\"keyParts\":[\"eventName\"]}}]}"], ["map", "matchingRules", "{\"type\":5,\"args\":[{\"stringValue\":\"sign_up\"},{\"contextValue\":{\"namespaceType\":1,\"keyParts\":[\"eventName\"]}}]}"], ["map", "matchingRules", "{\"type\":5,\"args\":[{\"stringValue\":\"login\"},{\"contextValue\":{\"namespaceType\":1,\"keyParts\":[\"eventName\"]}}]}"]],
                "vtp_instanceDestinationId": "G-ZKBVC1X78F",
                "tag_id": 18
            }, {
        ...
        ,
        "security_groups": {
            "google": ["__c", "__ccd_auto_redact", "__ccd_conversion_marking", "__ccd_em_scroll", "__ccd_ga_ads_link", "__ccd_ga_first", "__ccd_ga_last", "__ccd_ga_regscope", "__e", "__ogt_1p_data_v2", "__ogt_cross_domain", "__ogt_dma", "__ogt_google_signals", "__ogt_referral_exclusion", "__set_product_settings"
            ]
...
*/
    ...
    ;
    function Ee(a) {
        if (a instanceof Aa || a instanceof $c || a instanceof Yc || a instanceof La || a instanceof gd || a instanceof ed || a === null || a === void 0 || typeof a === "string" || typeof a === "number" || typeof a === "boolean")
            return a
    }
    ;var Ge = function(a) {
        this.message = a
    ...
    var xf = function(a, b, c) {
      ...
      , Af = function(a, b) {
        ...
        if (!c)
            throw Error("Error: No function name given for function call.");
        var e = nf[c], f = b && b.type === 2 && (d == null ? void 0 : d.reportMacroDiscrepancy) && e && tf.indexOf(c) !== -1, g = {}, k = {}, m;
        for (m in a)
    ...
    ;var Sf = function() {
        ...
        jb(a, function(g, k) {
            function m(p) {
                ...
                if (!n[p])
                    throw Qf(p, {}, "The requested additional permission " + p + " is not configured.");
            ...
            c.C[g] = function(p, q) {
                var r = n[p];
                if (!r)
                    throw Qf(p, {}, "The requested permission " + p + " is not configured.");
    ...
    function K(a, b, c) {
        for (var d = 0; d < b.length; d++) {
            ...
            if (m == null) {
                ...
                if (n !== k)
                    throw Error("Error in " + a + ". Argument " + f + " has type " + ((Eg[n] || n) + ", which does not match required type ") + ((Eg[k] || k) + "."));
            }
        }
    }
    ;function Fg(a) {
    ...
    ;var hi = function(a) {
        ...
        for (var f = l(a), g = f.next(); !g.done; g = f.next()) {
            var k = g.value;
            if (k.value !== "") {
                var m, n = void 0, p = k.name, q = k.value, r = di[p];
                if (r) {
                    var u = (n = k.index) != null ? n : ""
                      , v = r + "__" + e;
                    !ei(p) || /^e\d+$/.test(q) || fi.test(q) || Vh.test(q) ? m = encodeURIComponent(encodeURIComponent(q)) : (m = "${userData." + v + "|sha256}",
                    c[v] = q,
                    e++);
                    d.push("" + r + u + "." + m)
                }
      ...
      , oi = function(a) {
        for (var b = a.jf, c = a.time, d = ["tv.1"], e = 0, f = !1, g = 0; g < b.length; ++g) {
            var k = b[g].name
              ...
              , n = b[g].index
              , p = di[k];
            p && m && (!ei(k) || /^e\d+$/.test(m) || fi.test(m) || Vh.test(m)) && (n !== void 0 && (p += n),
            d.push(p + "." + m),
            e++)
        }
    ...
    Fi)
      , Gi = {}
      , ri = (Gi.email = "sha256_email_address",
    ...
    Hi.Ce = Number("0") || 0;
    Hi.ob = "dataLayer";
    Hi.Cn = "ChAIgIq3uQYQkKirgr6ygqkOEiUAu4ow19OqYnbEFrH/0YcI6wPQYSb20ild2TlpajDV7b2dITmqGgJ7TA\x3d\x3d";
    var Ji = {
        __cl: 1,
        __ecl: 1,
        __ehl: 1,
    ...
    function lj(a, b) {
        gj.hasOwnProperty(a) || (ej.set(a, b),
        Vc(yb(a, b), fj),
        hj())
    }
    function mj() {
    ...
    function tk() {
        ...
        if (a) {
            ...
            if (b.siloed) {
                ...
                g++)
                    f.hg = b.siloed[g],
                    !ek && eb(f.hg.isDestination ? e : d, function(k) {
                        return function(m) {
                            return m === k.hg.ctid
                        }
                    }(f)) ? ek = !0 : c.push(f.hg);
    ...
    function vk() {
        for (var a = Pf.ctid, b = hk(), c = kk(), d = function(n, p) {
                        ...
                        b: {
                            ...
                            if (t) {
                                for (var w = aj.H, x = Bj(t), y = w ? x.pathname : "" + x.hostname + x.pathname, A = E.scripts, B = "", D = 0; D < A.length; ++D) {
                                    var I = A[D];
                                    if (!(I.innerHTML.length === 0 || !w && I.innerHTML.indexOf(q.scriptContainerId || "SHOULD_NOT_BE_SET") < 0 || I.innerHTML.indexOf(y) < 0)) {
            ...
            var W = p ? e.destination : e.container
              , N = W[n];
            N ? (p && N.state === 0 && U(93),
            Object.assign(N, q)) : W[n] = q
        }, e = ak(), f = l(b), g = f.next(); !g.done; g = f.next())
            d(g.value, !1);
    ...
    ;var ml;
    try {
        ml = JSON.parse(Ta("eyIwIjoiQU0iLCIxIjoiQU0tRVIiLCIyIjpmYWxzZSwiMyI6Imdvb2dsZS5hbSIsIjQiOiIiLCI1Ijp0cnVlLCI2IjpmYWxzZSwiNyI6ImFkX3N0b3JhZ2V8YW5hbHl0aWNzX3N0b3JhZ2V8YWRfdXNlcl9kYXRhfGFkX3BlcnNvbmFsaXphdGlvbiJ9"))
    } catch (a) {
        U(123),
        ll(2),
        ml = {}
    ...
    var ul = [O.g.O, O.g.U, O.g.N, O.g.za], vl, wl;
    function xl(a) {
    ...
    ;function Rl() {
        if (Ii.pscdl !== void 0)
            Ol(Jl.uf) === void 0 && Nl(Jl.uf, Ii.pscdl);
        else {
            var a = function(c) {
                Ii.pscdl = c;
                Nl(Jl.uf, c)
    ...
    ;var mm = function(a, b, c, d, e, f, g, k, m, n, p) {
      ...
      , qm = function(a) {
        for (var b = [O.g.Zc, O.g.Vc, O.g.Wc, O.g.Xc, O.g.Yc, O.g.bd, O.g.dd], c = nm(a, 3), d = l(c), e = d.next(); !e.done; e = d.next()) {
                ...
                b.addEventListener(function(c) {
                    ...
                    !ro(c) || oo() || po()) {
                        ...
                        if (d) {
                            ...
                            q);
                            a.gdprApplies !== !0 ? (Gl([O.g.O, O.g.za, O.g.N]),
                            Qk().active = !0) : (r[O.g.za] = a.uc["3"] && a.uc["4"] ? "granted" : "denied",
                            typeof a.tcfPolicyVersion === "number" && a.tcfPolicyVersion >= 4 ? r[O.g.N] = a.uc["1"] && a.uc["7"] ? "granted" : "denied" : Gl([O.g.N]),
                            Al(r, {
                                eventId: 0
                            }, {
    ...
    function zo(a) {
        if (ol() === "US-CO" && gc.globalPrivacyControl === !0)
            return !1;
        var b = yo(a);
        if (b === 3)
            return !1;
    ...
    function Fo(a) {
        for (var b = "1", c = 0; c < vo.length; c++) {
            var d = b, e, f = vo[c], g = Xk.delegatedConsentTypes[f];
    ...
    function No(a) {
        ...
        Oi ? (c.og = Mo[b],
        c.og || (c.og = 0)) : c.og = Si ? 13 : 10;
        aj.H ? (c.mg = 0,
        c.Jl = 2) : Qi ? c.mg = 1 : Lo() ? c.mg = 2 : c.mg = 3;
        var e = {};
        e[6] = ek;
        ...
        m === void 0 ? k = "" : (n || (n = 0),
        k = "" + Ke(1, 1) + He(m << 2 | n));
        var p = c.Jl, q = "4" + k + (p ? "" + Ke(2, 1) + He(p) : ""), r, u = c.kn;
        ...
        if (x && g) {
            ...
            w = "";
        var D = c.qn, I = c.Je, J = c.ya, H = c.mo, W = q + r + v + w + (D ? "" + Ke(6, 1) + He(D) : "") + (I ? "" + Ke(7, 3) + He(I.length) + I : "") + (J ? "" + Ke(8, 3) + He(J.length) + J : "") + (H ? "" + Ke(9, 3) + He(H.length) + H : ""), N;
        var aa = c.Ml;
        aa = aa === void 0 ? {} : aa;
    ...
    function Sq(a, b, c, d, e, f) {
        ...
        c && k(c, "dc");
        d !== void 0 && uq.test(d) && (g.wbraid = d,
        k(d, "gb"));
        e !== void 0 && uq.test(e) && (g.gbraid = e,
        k(e, "ag"));
        f !== void 0 && uq.test(f) && (g.gad_source = f,
        k(f, "gs"));
        return g
    }
    function Uq(a) {
    ...
    function Vq(a, b, c, d, e) {
        ...
        var f = Eq(c.prefix)
          ...
          , q = function() {
            ...
            if (!p && a.gbraid && yq("ad_storage") && (p = !0,
            !n)) {
                var B = a.gbraid
                  , D = Fq("ag", f);
    ...
    function Xq(a, b, c, d) {
        if (a.gad_source !== void 0 && yq("ad_storage")) {
            ...
            if (g) {
                ...
                if ($a(11)) {
                    var n, p = String, q = C.location.hostname, r = C.location.pathname, u = q = Dj(q);
        ...
        if (Po(C)) {
            ...
            zq(function() {
                jb(d, function(f, g) {
                    ...
                    if (k.length) {
                        var m = k[0], n = Zq(m), p = ar(m.split(".")).length !== 0 ? m.split(".").slice(3) : [], q = {}, r;
    ...
    ;var pr = function(a, b) {
            ...
            sr(function() {
                ...
                if (v) {
                    ...
                    if (B.length !== 0 || r !== void 0) {
                        ...
                        if (!c) {
                            var H = {};
                            c = Cm(sm(new rm(0), (H[O.g.ma] = Xm.j[O.g.ma],
                            H)))
                        }
                        t.push("gtm=" + No({
                            ya: b
      ...
      , rr = function() {
        var a = Bj(C.location.href), b = void 0, c = void 0, d = vj(a, "query", !1, void 0, "gad_source"), e, f = a.hash.replace("#", "").match(zr);
        e = f ? f[1] : void 0;
        d && e ? (b = d,
        c = 1) : d ? (b = d,
        c = 2) : e && (b = e,
    ...
    function Rr(a) {
        var b = $a(11), c = {}, d, e, f;
        Lr.test(E.location.host) && (d = Qr("gclgs"),
        e = Qr("gclst"),
        b && (f = Qr("gcllp")));
        if (d && e && (!b || f))
            c.Mh = d,
    ...
    ;var bs = function(a) {
        if (a.eventName === O.g.ba && a.metadata.hit_type === "page_view")
            if (S(20)) {
                ...
                if (e)
                    ...
                    hl = !0;
                    var r = X([O.g.O, O.g.N]);
                    r && (S(24) && (a.j[O.g.ib] = as()),
                    c && (Rp(b),
                    a.j[O.g.Lb] = Pp[Sp(b.prefix)]));
                    a.j[O.g.rb] = void 0;
                    a.j[O.g.Za] = void 0;
      ...
      , $r = function(a) {
        ...
        d = a.Pd;
        e = a.rc;
        b && (Np(c[O.g.Hc], !!c[O.g.X]) && (Yq(ds, e),
        $q(e),
        Zp(e)),
        S(86) || S(115) ? Wq(e) : Uq(e),
        dr(ds, e),
        er(e));
        c[O.g.X] && (br(ds, c[O.g.X], c[O.g.Pb], !!c[O.g.yb], e.prefix),
    ...
    function hs(a) {
        var b = V(a.m, O.g.Ob)
          , c = V(a.m, O.g.jc);
        b && !c ? (a.eventName !== O.g.ba && a.eventName !== O.g.Uc && U(131),
    ...
    var ps = function(a, b) {
      ...
      , rs = function(a) {
        ...
        pr(c) && El(function() {
            function d(x) {
                var y = X([O.g.O, O.g.N]), A = m && y, B = b.prefix || "_gcl", D;
                Ii.reported_gclid || (Ii.reported_gclid = {});
                D = Ii.reported_gclid;
                var I = (A ? B : "") + "." + (X(O.g.O) ? 1 : 0) + "." + (X(O.g.N) ? 1 : 0);
                if (!D[I]) {
                    D[I] = !0;
                    var J = {}
                      , H = function(R, M) {
                    ...
                    H("gclid", ps(f, p));
                    H("gclsrc", q);
                    if (!(J.hasOwnProperty("gclid") || J.hasOwnProperty("dclid") || J.hasOwnProperty("gclaw")) && (H("gbraid", ps(f, u)),
      ...
      , ts = function(a, b, c, d, e) {
        ...
        if (b && c) {
            ...
            for (var f = {
                ...
                zs(f.adData, d),
                ys[k.id] = !0) : k && k.prefix === "UA" && !f.gaData && (f.gaData = {
    ...
    var Wt = function(a, b) {
      ...
      , Xt = function() {
        ...
        if (a) {
            var b;
            return vj(Bj(a), "host") === ((b = C.location) == null ? void 0 : b.host) ? 1 : 2
        }
        return 0
    }
      , Yt = function(a) {
    ...
    Yt.prototype.C = function(a, b, c, d) {
        var e = Xt(), f, g = [];
        f = C === C.top && e !== 0 && b ? (b == null ? void 0 : b.clientCount) > 1 ? e === 2 ? 1 : 2 : e === 2 ? 0 : 3 : 4;
        a && Vt("si", a.Ye, g);
        Vt("m", 0, g);
        Vt("iss", f, g);
        Vt("if", c, g);
    ...
    h.Am = function(a, b, c) {
        var d = C.location.origin
          ...
          , f = rc();
        try {
            var g = f.contentDocument.createElement("iframe"), k = a.pathname, m = k[k.length - 1] === "/" ? a.toString() : a.toString() + "/", n = b ? du(k) : "", p;
            S(107) && (p = {
    ...
    function ju(a, b, c) {
        ...
        if (!d || !iu())
            return;
        cj() && (a = "" + d + bj() + "/_",
        S(105) && (a += "/service_worker"));
        var e = fu(a);
        if (e === null || gu(e.origin))
            return;
        if (!hc()) {
            cu().C(void 0, void 0, 6);
            return
        }
        var f = new hu(e,!!a,b || Math.round(qb()),cu(),c), g;
        a: {
            var k = Jl.Tj
              , m = {}
              , n = Ml(k);
    ...
    function lu(a, b, c, d, e) {
        ...
        var g, k = (g = gu(f.origin)) == null ? void 0 : g.initTime, m = Math.round(qb()), n = {
            commandType: 0,
            params: {
                url: a,
                method: 0,
    ...
    function mu(a, b, c, d) {
        ...
        var f = b ? 1 : 0, g = Math.round(qb()), k, m = (k = gu(e.origin)) == null ? void 0 : k.initTime, n = m ? g - m : void 0;
        ku(e.origin, {
            commandType: 0,
            params: {
                url: a,
            ...
            var q = "_is_sw=f" + p.failureType, r, u = (r = gu(e.origin)) == null ? void 0 : r.getState();
            u !== void 0 && (q += "s" + u);
            d(n ? q + ("t" + n) : q + "te")
        });
    }
    ...
    ;var Ju = function() {
      ...
      , Lu = function(a) {
        S(20) && a.eventName === O.g.ba && Ku(a, "page_view") && !a.metadata.consent_updated && !a.m.isGtmEvent ? xs(a.target, a.m) : Ku(a, "call_conversion") && (xs(a.target, a.m),
        a.isAborted = !0)
    }
      , Nu = function(a) {
        var b;
      ...
      , Pu = function(a) {
        Ku(a, ["conversion"]) && a.m.eventMetadata.is_external_event && (a.j[O.g.Fj] = !0)
    }
      , Qu = function(a) {
        var b = X(Ju());
        switch (a.metadata.hit_type) {
      ...
      , Su = function(a) {
        if (Ku(a, ["conversion", "user_data_web"])) {
            var b;
            if (!(S(55) || S(56) || S(57) || S(58) || S(59)) || Ku(a, ["user_data_web"]) && !a.metadata.speculative_ecw_stitching_ping)
                b = !1;
            else {
            ...
            if (b) {
                ...
                S(55) ? a.metadata.split_experiment_arm = 1 : S(56) ? a.metadata.split_experiment_arm = 2 : S(57) ? (a.metadata.split_experiment_arm = 3,
                d && Mu(a)) : S(58) ? (a.metadata.split_experiment_arm = 4,
                d && Mu(a)) : S(59) && (a.metadata.split_experiment_arm = 5,
                d && Mu(a))
            } else
      ...
      , Tu = function(a) {
        S(55) || S(56) || S(57) || S(58) || S(59) || cj() || Qi || Ij(a.m) || S(104) && ju(void 0, Math.round(qb()), S(103))
    }
      , Uu = function(a) {
        if (Ku(a, ["conversion", "remarketing", "user_data_lead", "user_data_web"]) && a.metadata.conversion_linker_enabled && X(O.g.O)) {
            var b = !S(3);
      ...
      , Xu = function(a) {
        Ku(a, ["conversion"]) && (a.metadata.redact_click_ids = !!a.metadata.redact_ads_data && !X(Ju()))
    }
      , Yu = function(a) {
      ...
      , bv = function(a) {
        S(41) && Ku(a, "conversion") && (a.copyToHitData(O.g.Eg),
        a.copyToHitData(O.g.Fg),
        a.copyToHitData(O.g.Dg))
    }
      , cv = function(a) {
        Ku(a, "conversion") && (a.copyToHitData(O.g.nd),
      ...
      , dv = function(a) {
        if (Ku(a, ["conversion", "remarketing", "user_data_lead", "user_data_web"])) {
            ...
            zo(b) ? a.j[O.g.Tb] = !1 : (a.j[O.g.Tb] = !0,
            Ku(a, "remarketing") && (a.isAborted = !0))
        }
    }
      , ev = function(a) {
        if (Ku(a, ["conversion", "remarketing"])) {
            var b = a.metadata.hit_type === "conversion";
            b && a.eventName !== O.g.Ma || (a.copyToHitData(O.g.da),
            b && (a.copyToHitData(O.g.Zd),
            a.copyToHitData(O.g.Xd),
            a.copyToHitData(O.g.Yd),
            a.copyToHitData(O.g.Wd),
            a.j[O.g.Bg] = a.eventName,
            S(88) && (a.copyToHitData(O.g.Mf),
        ...
        if (a.eventName === O.g.Ya && !a.m.isGtmEvent) {
            if (!a.metadata.consent_updated && Ku(a, "conversion")) {
                ...
                var c = String(V(a.m, O.g.xb))
                  , d = a.j[c]
                  , e = V(a.m, c);
                c === O.g.Za || c === O.g.Lb ? gs({
                    Ik: c,
                    callback: b,
                    pk: e
                }, a.metadata.cookie_options, a.metadata.redact_ads_data, Dr) : b(d || e)
            }
            a.isAborted = !0
        }
    }
      , jv = function(a) {
        if (!Nt(a, "hasPreAutoPiiCcdRule", !1) && Ku(a, "conversion") && X(O.g.O)) {
            var b = (V(a.m, O.g.fe) || {})[String(a.j[O.g.ub])], c = a.j[O.g.ed], d;
            if (!(d = ns(b)))
                if (sl())
                    if (wt)
                        d = !0;
      ...
      , kv = function(a) {
        if (a.eventName === O.g.ba && !a.metadata.consent_updated && (a.metadata.is_config_command = !0,
        Ku(a, "conversion") && (a.metadata.speculative = !0),
        !Ku(a, "remarketing") || V(a.m, O.g.bc) !== !1 && V(a.m, O.g.Oa) !== !1 || (a.metadata.speculative = !0),
        Ku(a, "landing_page"))) {
            var b = V(a.m, O.g.sa) || {}
              , c = V(a.m, O.g.cb)
      ...
      , lv = function(a) {
        Ku(a, ["conversion", "remarketing"]) && (a.m.isGtmEvent ? a.metadata.hit_type !== "conversion" && a.eventName && (a.j[O.g.Cc] = a.eventName) : a.j[O.g.Cc] = a.eventName,
        jb(a.m.j, function(b, c) {
            Ch[b.split(".")[0]] || (a.j[b] = c)
        }))
    }
      , mv = function(a) {
        var b = !a.metadata.send_user_data_hit && Ku(a, ["conversion", "user_data_web"])
        ...
        if ((b || c) && X(O.g.O)) {
            ...
            if (d || a.metadata.speculative_ecw_stitching_ping) {
                ...
                if (V(e, O.g.Vd) === !0 || k) {
                    ...
                    var p = (k || {}).enhanced_conversions_mode, q;
                    if (n) {
                        if (p === "manual")
                            switch (n._tag_mode) {
                            case "CODE":
      ...
      , nv = function(a) {
        if (Nt(a, "ccd_add_1p_data", !1) && X(Ju())) {
            ...
            if (rj(b)) {
                ...
                Uc(b.selectors) && (a.metadata.user_data_from_manual = pj(b.selectors)))
            }
        }
    }
      , ov = function(a) {
                    ...
                    if (V(a.m, O.g.Ea) !== !1 || b(2))
                        if (zo(a.m) || b(3))
                            if (V(a.m, O.g.bc) !== !1 || b(4))
                                if ((S(32) ? a.eventName === O.g.ba ? V(a.m, O.g.Oa) : void 0 : V(a.m, O.g.Oa)) !== !1 || b(5))
                                    if (Eu() || b(6))
                                        S(31) && Xa() ? (a.j[O.g.gj] = Wa("fdr"),
                                        delete Ua.fdr) : (a.j[O.g.Mg] = "1",
                                        a.metadata.send_fledge_experiment = !0)
        }
    }
      , qv = function(a) {
        Ku(a, ["conversion"]) && X(O.g.N) && (C._gtmpcm === !0 || Ks() ? a.j[O.g.fc] = "2" : S(33) && Du("attribution-reporting") && (a.j[O.g.fc] = "1"))
    }
      , rv = function(a) {
        if (!vu(C))
            U(87);
      ...
      , tv = function(a) {
        Ku(a, ["conversion", "remarketing"]) && (a.copyToHitData(O.g.Ba),
      ...
      , xv = function(a) {
        if (Ku(a, ["conversion", "remarketing", "user_data_lead", "user_data_web"])) {
            ...
            case "conversion":
                ...
                (wv() ? 0 : S(128)) && (a.metadata.is_fallback_aw_conversion_ping_allowed = !0);
                break;
            case "user_data_lead":
            case "user_data_web":
                !c && b && (S(57) || S(58) || S(59) ? a.metadata.speculative_ecw_stitching_ping = !0 : a.isAborted = !0);
                break;
            case "remarketing":
                !c && b || Mu(a)
            }
            Ku(a, ["conversion", "remarketing"]) && (a.j[O.g.Ej] = a.metadata.is_gcp_conversion ? "www.google.com" : "www.googleadservices.com")
        }
    }
      , wv = function() {
        return gc.userAgent.toLowerCase().indexOf("firefox") !== -1 || lc("Edg/") || lc("EdgA/") || lc("EdgiOS/")
    }
      , yv = function(a) {
    ...
    ;var yw = function() {
      ...
      , Gw = function(a, b) {
        var c = a.metadata.hit_type, d = a.j[O.g.ed], e = X([O.g.O, O.g.N]), f = [], g, k = a.m.onSuccess, m, n = Lo() ? 2 : 3, p = 0, q = void 0, r = function(A) {
            f.push(A);
            A.Da && p++
        };
        switch (c) {
        case "conversion":
            ...
            q = 8) : (g = "https://www.googleadservices.com",
            q = 5) : (g = "https://pagead2.googlesyndication.com",
            q = 6);
            ...
            e && a.metadata.is_fallback_aw_conversion_ping_allowed && (v.Oe = "" + Jj("https://www.google.com", !0) + "/pagead/1p-conversion/" + d + "/?" + Fw(a, b) + "&gcp=1&sscte=1&ct_cookie_present=1",
            v.Ne = 8);
            r(v);
            ...
            a.metadata.is_gcp_conversion && e && (u = "&gcp=1&ct_cookie_present=1",
            r({
                Ha: "" + Jj("https://googleads.g.doubleclick.net") + "/pagead/viewthroughconversion/" + d + "/?" + Fw(a, b) + u,
                format: n,
                Da: !0,
                endpoint: 9
            }));
        ...
        case "remarketing":
            ...
            if (x.length) {
                for (var y = 0; y < x.length; y++)
                    b.data = Dw(w, x[y]),
                    r({
                        Ha: "" + Jj("https://googleads.g.doubleclick.net") + "/pagead/viewthroughconversion/" + d + "/?" + Fw(a, b),
                        format: n,
                        Da: !0,
                        endpoint: 9
                    }),
        ...
        case "user_data_lead":
            r({
                Ha: "" + Jj("https://google.com") + "/pagead/form-data/" + d + "?" + Fw(a, b),
                format: 1,
                Da: !0,
                endpoint: 11
            });
        ...
        case "user_data_web":
            r({
                Ha: "" + Jj("https://google.com") + "/ccm/form-data/" + d + "?" + Fw(a, b),
                format: 1,
                Da: !0,
                endpoint: 21
            });
        ...
        case "ga_conversion":
            ...
            q = 54) : (g = "https://pagead2.googlesyndication.com",
            q = 55),
            r({
        ...
        Lo() || c !== "conversion" && c !== "remarketing" || !a.metadata.send_fledge_experiment || (S(30) && c === "conversion" && (b.ct_cookie_present = 0),
        r({
            Ha: "" + Hu() + "/td/rul/" + d + "?" + Fw(a, b),
            format: 4,
            Da: !1,
      ...
      , Kw = function(a, b, c) {
        function d(n, p) {
            ...
            q("a", e);
            q("s", yw() ? 1 : 0);
            n !== void 0 && (n.Gb && !p && (q("fem", n.Gb.replace(/./g, "*")),
            n.time !== void 0 && q("ht", String(n.time))),
            n.xa && (n.xa.Cd && q("feme", n.xa.Cd.replace(/./g, "*")),
            q("est", n.xa.time),
            q("es", n.xa.status)));
            c._ece = r.join("~");
      ...
      , Mw = function(a) {
        a.metadata.hit_type === "page_view" ? Bv(a) : Lw(a, function(b, c) {
            S(97) && delete b.em;
            for (var d = Gw(a, b), e = d.onSuccess, f = d.ym, g = {}, k = 0; k < f.length; g = {
                Oe: void 0,
                Ne: void 0,
                gg: void 0,
                Ha: void 0,
                    ...
                    var p = function(w) {
                        return function(x) {
                            Ai(c.Nm, function(y) {
                                ...
                                Hw(B + "&em=" + encodeURIComponent(A.Gb), w.Lh, a, b, w.Hh, w.Da ? e : void 0, void 0, w.gg)
                            })
                        }
                    }(g)
                      , q = c
        ...
        if ((c === "conversion" || c === "user_data_lead" || c === "user_data_web") && a.metadata.user_data)
            if (!X(O.g.N) || S(16) && !X(O.g.O))
                ...
                if (a.metadata.split_experiment_arm && a.metadata.fake_user_data) {
                    ...
                    S(103) && (H.push("&eme=" + I),
                    f.encryptionKeyString = J);
                    D > 0 && x()
                } else {
                    var W, N = a.metadata.user_data, aa = Iw(c);
                    if (W = S(82) || S(83) ? mi(N, S(83) && aa) : ni(N)) {
                        var da = W.then(function(T) {
                            ...
                            if ((S(53) || S(83)) && T.Ld > 0 && T.time !== void 0) {
                                var M = zw(T.time);
                                d._ht = "t." + (M === void 0 ? "" : M) + ("~l." + zw(R.length))
                            }
                            T.Ld > 0 && x();
                            if (aa) {}
                        });
    ...
    function Yw() {
        ...
        Uw.test(C.location && C.location.hostname) && (Oi ? U(116) : (U(117),
        Zw && (a = [],
        ...
        c ? U(8) : c = [];
        Uw.test(C.location && C.location.hostname) && (c = nb(c),
        ...
        return function(f) {
            ...
            var v = !m || q;
            v || !(k.indexOf("sandboxedScripts") >= 0) || b && b.indexOf("sandboxedScripts") !== -1 || (v = hb(d, Xw));
            return e[g] = v
        }
    }
    var Zw = !1;
            ...
            if (!wk(f)) {
                ...
                if (S(69) && cj())
                    ...
                    if (!q) {
                        ...
                        q = ss("https://", "http://", r + k)) : q = cj() ? bj() + "/" + k : ss("https://", "http://", r + k)
                    }
                    pc(q)
                }
            }
            ...
            if (!xk(e))
                ...
                S(69) && cj())
                    ...
                    var f = "/gtag/destination" + cx(a, !0)
                      , g = Gj(b, f);
                    g || (cj() ? (f = "/gtd" + cx(a, !0),
                    g = bj() + f) : g = ss("https://", "http://", Hi.vf + f));
                    pc(g)
                }
        }
    }
    ...
    ;var Jx = {}
      ...
      , Lx = {};
    function Mx(a, b, c, d) {
        Qj && S(92) && ((d === void 0 ? 0 : d) ? (Lx[b] = Lx[b] || 0,
        ++Lx[b]) : c !== void 0 ? (Kx[a] = Kx[a] || {},
        Kx[a][b] = Math.round(c)) : (Jx[a] = Jx[a] || {},
        Jx[a][b] = (Jx[a][b] || 0) + 1))
    }
    function Nx(a) {
        var b = a.eventId, c = a.Tc, d = Jx[b] || {}, e = [], f;
        for (f in d)
    ...
    function Ox(a) {
        var b = a.eventId, c = a.Tc, d = Kx[b] || {}, e = [], f;
        for (f in d)
            d.hasOwnProperty(f) && e.push("" + f + d[f]);
        c && delete Kx[b];
    ...
    function jy(a) {
        for (var b = [], c = 0; c < a.length; c++)
            if (a[c]) {
                ...
                if (Ji[d] || lf[c][Le.yl] !== void 0 || Nw(d, 2))
                    b[c] = !0
            }
        return b
    }
    function ky(a, b) {
        if (!b)
            return b;
        for (var c = 0; c < a.length; c++)
            if (a[c] && lf[c] && !Ki[String(lf[c][Le.oa])])
                return !0;
        return !1
    }
    var ly = 0;
                ...
                if (e) {
                    ...
                    if (u ? kk().indexOf(r) === -1 : hk().indexOf(r) === -1) {
                        ...
                        b.inheritParentConfig)) {
                            ...
                            var x = d;
                            Sy ? (Ty(b, Sy, x),
                            w = !1) : (!x[O.g.nc] && Mi && Ry || (Ry = Vc(x, null)),
                            w = !0);
        ...
        consent: function(a, b) {
            if (a.length === 3) {
                ...
                var c = Qy(a, b)
                  , d = a[1]
                  , e = a[2];
                b.fromContainerExecution || (e[O.g.N] && U(139),
                e[O.g.za] && U(140));
    ...
    ;function dA() {
        var a = [["cv", S(114) ? cA() : "7"], ["rv", Hi.th], ["tc", lf.filter(function(b) {
            return b
        }).length]];
    ...
    function RB(a, b) {
        var c = this;
        K(this.getName(), ["callback:!Fn", "requiredConsentTypes:!List"], arguments),
        El(function() {
            a.invoke(c.D)
        }, G(b));
    }
    ...
    function bC(a) {
        ...
        }, this.D, vb(vA(this).kb(), "__cvt_") ? 2 : 1)
    }
    bC.T = "createQueue";
    function cC(a, b) {
        var c = null;
    ...
    function dC() {
        var a = {};
        a = {
            COOKIE_DEPRECATION_LABEL: Jl.uf,
            SHARED_USER_ID: Jl.vh,
            SHARED_USER_ID_REQUESTED: Jl.wh,
            SHARED_USER_ID_SOURCE: Jl.Ee
        };
        return a
    }
    ;function eC(a) {
    ...
    var gD = function(a) {
      ...
      , jD = function(a, b) {
        yA("sdl", "init", !1) && !mD() && (b ? vc(C, "scrollend", a) : vc(C, "scroll", a),
        vc(C, "resize", a),
        zA("sdl", "init", !1))
    }
      , iD = function() {
      ...
      , mD = function() {
        return !!(Object.keys(gD("horiz.pix")).length || Object.keys(gD("horiz.pct")).length || Object.keys(gD("vert.pix")).length || Object.keys(gD("vert.pct")).length)
    };
    function qD(a, b) {
        var c = this;
        ...
        yA("sdl", "init", !1) ? yA("sdl", "pending", !1) || F(function() {
            iD()
        }) : (zA("sdl", "init", !0),
        zA("sdl", "pending", !0),
        F(function() {
    ...
    var Zb = ma(["data-gtm-yt-inspected-"]), uD = ["www.youtube.com", "www.youtube-nocookie.com"], vD, wD = !1;
    function GD(a, b) {
        var c = this;
        return b
    }
    ...
    var KD = function(a) {
        ...
        case "call_conversion":
            return [ks, Lu];
        case "conversion":
            return [hs, ks, ov, yv, lv, xv, vv, uv, tv, sv, fv, ev, cv, bv, $u, Pu, Ou, dv, Tu, kv, Zu, Yu, Wu, nv, jv, Ru, ls, is, iv, Uu, rv, av, mv, Su, Nu, hv, Xu, pv, qv, Qu];
        case "landing_page":
            return [hs, ks, ov, yv, fv, js, Tu, kv, nv, is, ls, iv, rv, av, mv, Nu, Qu];
        case "remarketing":
            return [hs, ks, ov, yv, lv, xv, vv, uv, tv, sv, fv, ev, $u, dv, Tu, kv, Zu, nv, is, ls, iv, Uu, rv, av, mv, Nu, pv, Qu];
        case "user_data_lead":
            return [hs, ks, ov, yv, xv, sv, fv, dv, Tu, js, kv, Wu, nv, is, ls, iv, Uu, rv, av, mv, Nu, Qu];
        case "user_data_web":
            return [hs, ks, ov, yv, xv, sv, fv, dv, Tu, js, kv, Wu, nv, is, ls, iv, Uu, rv, av, mv, Su, Nu, Qu];
        default:
            return [hs, ks, ov, yv, lv, xv, vv, uv, tv, sv, fv, ev, cv, bv, $u, Pu, Ou, dv, Tu, kv, Zu, Yu, Wu, nv, jv, Ru, is, ls, iv, Uu, rv, av, mv, Nu, hv, Xu, pv, qv, Qu]
        }
    }
      , LD = function(a) {
        for (var b = KD(a.metadata.hit_type), c = 0; c < b.length && (b[c](a),
        !a.isAborted); c++)
            ;
    }
      , MD = function(a, b, c, d) {
      ...
      , ND = function(a, b, c, d) {
        ...
        function f(u) {
            ...
            t++)
                if (v.Va = k[t],
                !u || u(v.Va.metadata.hit_type))
                    if (!v.Va.metadata.consent_updated || v.Va.metadata.hit_type === "page_view" || X(q))
                        LD(k[t]),
                        v.Va.metadata.speculative || v.Va.isAborted || (Mw(v.Va),
                        v.Va.metadata.hit_type === "page_view" && v.Va.j[O.g.Qf] === void 0 && r === void 0 && (r = Pl(Jl.Ee, function(w) {
                            return function() {
                                X(O.g.N) && (w.Va.metadata.user_id_updated = !0,
        ...
        if (g) {
            ...
            if (d.eventMetadata.hit_type_override) {
                ...
                Array.isArray(m) || (m = [m]);
                (S(57) || S(58) || S(59)) && m.indexOf("conversion") >= 0 && m.indexOf("user_data_web") < 0 && m.push("user_data_web");
                for (var n = 0; n < m.length; n++) {
                    var p = MD(m[n], g, b, d);
                ...
                b === O.g.ba && (S(20) ? k.push(MD("page_view", g, b, d)) : k.push(MD("landing_page", g, b, d))),
    ...
    function qF(a, b) {
        ...
        var d = G(a, this.D, 1).Ub().metadata.cookie_options || {};
        Rp(d, b);
        c = Pp[Sp(d.prefix)];
        return c
    }
    ...
    function sF() {
        ...
        S(43) && rF ? a = rF : (a.set("containerId", 'G-ZKBVC1X78F'),
        a.set("version", '7'),
    ...
    function IF(a) {
        var b;
        K(this.getName(), ["avoidWarnings:!boolean"], arguments),
        b = Mn(a);
        return b
    }
    ...
    ;var gG = function(a, b, c) {
      ...
      , iG = function(a, b) {
        var c = a.j[O.g.tb];
        if (V(a.m, O.g.Ob) && V(a.m, O.g.jc) || b && c === b)
            return c;
        if (c) {
            c = "" + c;
            if (!hG(c, a))
    ...
    var nG = function(a, b, c) {
      ...
      , sG = function(a) {
        return mG(a.j[O.g.zb], a.j[O.g.te], a.j[O.g.se], Math.floor(a.metadata.event_start_timestamp_ms / 1E3), a.metadata.join_timer_sec || 0, !!a.metadata[O.g.Hf], a.j[O.g.ee])
    }
    ...
    var tG = function(a) {
      ...
      , zG = function(a) {
        var b = tG(a) || {}
          ...
          , e = oG(a, c)
          , f = {};
        Np(b[O.g.Hc], !!b[O.g.X]) && (f = vG(a, d, e),
        f.clientId && f.Wa && (yG = !0));
        b[O.g.X] && Kp(function() {
            var g = {}
              , k = kG(a);
            k && (g[d] = k);
    ...
    var FG = function(a) {
        if (V(a.m, O.g.ld) !== void 0)
            a.copyToHitData(O.g.ld);
        else {
            var b = V(a.m, O.g.Nf), c, d;
            a: {
                if (yG) {
                    var e = tG(a) || {};
                    if (e && e[O.g.X])
    ...
    PG)
      , RG = function(a, b, c) {
        ...
        d._p = S(129) ? Vi : eG();
        if (c && (c.Ld > 0 || c.jg) && (S(97) || (d.em = c.Gb),
        c.xa)) {
            var g = c.xa.Cd;
        ...
        jb(a.j, function(v, t) {
            if (t !== void 0 && !oh.hasOwnProperty(v)) {
                ...
                var w;
                var x = t;
                v !== O.g.ee ? w = !1 : a.metadata.euid_mode_enabled || Qt(a) ? (d.ecid = x,
                w = !0) : w = void 0;
                if (!w && v !== O.g.Hf) {
                    var y = t;
                    t === !0 && (y = "1");
                    ...
                    if (LG[v])
                        ...
                        var B;
                        OG[v] ? B = !0 : v !== O.g.Zc ? B = !1 : (typeof t !== "object" && q(v, t),
                        B = !0);
                        B || q(v, t)
                    }
                }
        ...
        jb(r, function(v, t) {
            t !== void 0 && ((t === null && (t = ""),
            v !== O.g.Ca || f.uid) ? b[v] !== t && (e[(cb(t) ? "upn." : "up.") + String(v)] = String(t),
        ...
        for (var c = b.indexOf("\n\n"); c !== -1; ) {
            ...
            if (n) {
                ...
                if (x && A) {
                    var B = x || [];
                    if (Array.isArray(B))
                        for (var D = Uc(y) ? y : {}, I = l(B), J = I.next(); !J.done; J = I.next())
                            A(J.value, D)
                }
            }
            b = b.substring(c + 2);
    ...
    var dH = function(a, b) {
      ...
      , hH = function(a, b) {
        ...
        if (d || e) {
            ...
            p();
            a.ja.frm != null && c("frm");
            d && (aj.j && n.push("tag_exp=" + aj.j),
            eH("https://stats.g.doubleclick.net/g/collect", "v=2&" + n.join("&")),
            n.join("&"));
            if (e) {
                var q = function() {
                    var v = Hu() + "/td/ga/rul?";
    ...
    var mH = function(a, b, c) {
      ...
      , wH = function(a) {
        Qt(a) && (a.metadata.speculative && Mt(a, "sp", 1),
        a.metadata.is_syn && Mt(a, "syn", 1),
        a.metadata.em_event && (Mt(a, "em_event", 1),
        Mt(a, "sp", 1)))
    }
      , xH = function(a) {
        if (Qt(a)) {
    ...
    var FH = function(a, b) {
      ...
      , GH = function(a, b, c, d, e) {
        ...
        if (v)
            ...
            d.qm(a);
        else if (d.gm() > r || a.eventName === O.g.ac)
            u.Nd = !0;
        a.metadata.euid_mode_enabled ? V(a.m, O.g.Ca) ? u.Mc = !0 : (u.Mc && !S(13) && (u.Dd = void 0),
        u.Mc = !1) : u.Mc = !1;
        var t = u.Dd;
    ...
    var HH = window
      ...
      , JH = function(a) {
        ...
        if (b && b.ioo && b.ioo() || IH.documentElement.hasAttribute("data-google-analytics-opt-out") || a && HH["ga-disable-" + a] === !0)
            return !0;
        try {
            var c = HH.external;
    ...
    var XH = function(a) {
      ...
      , YH = function(a) {
        gc && gc.loadPurpose === "preview" && (U(30),
        a.isAborted = !0)
    }
      , ZH = function(a) {
        var b = {
      ...
      , aI = function(a) {
        ...
        else if (Nt(a, "ccd_add_1p_data", !1) || Nt(a, "ccd_add_ec_stitching", !1))
      ...
      , bI = function(a) {
        if (a.metadata.euid_mode_enabled && Nt(a, "ccd_add_1p_data", !1)) {
            ...
            if (rj(b)) {
                var c = V(a.m, O.g.Ga);
                c === null ? a.metadata.user_data_from_code = null : (b.enable_code && Uc(c) && (a.metadata.user_data_from_code = c),
                Uc(b.selectors) && !a.metadata.user_data_from_manual && (a.metadata.user_data_from_manual = pj(b.selectors)))
            }
        }
    }
      , cI = function(a) {
      ...
      , dI = function(a) {
        a.eventName === O.g.ba && (V(a.m, O.g.Oa, !0) ? (a.m.j[O.g.fa] && (a.m.H[O.g.fa] = a.m.j[O.g.fa],
        a.m.j[O.g.fa] = void 0,
        a.j[O.g.fa] = void 0),
      ...
      , tI = function(a) {
        if (S(106) && X(O.g.U)) {
            Qt(a) && (a.metadata.is_sgtm_service_worker = !0,
            Qt(a) && Mt(a, "sw_exp", 1));
            a: {
                if (!S(106))
                    break a;
                if (Qt(a)) {
                    var b = "/_";
                    S(105) && (b += "/service_worker");
                    var c = Fj(Ij(a.m), b);
                    ju(c, Math.round(qb()));
                    break a
                }
                Qi || ju(void 0, Math.round(qb()));
            }
        }
    }
      , pI = function(a) {
      ...
      , iI = function(a) {
        ...
        if (!(cj() || S(6) && Qt(a) || a.metadata.is_merchant_center || V(a.m, O.g.sb) === !1) && qE() && X(O.g.O)) {
            var b = Rt(a);
      ...
      , jI = function(a) {
        ...
        a.metadata.is_first_visit && (a.metadata.is_first_visit_conversion = b(Ot(a, "first_visit")));
    ...
    function DI() {
        ...
        a = {
            EventNames: {
                APP_REMOVE: O.g.Gi,
                APP_STORE_REFUND: O.g.Hi,
                APP_STORE_SUBSCRIPTION_CANCEL: O.g.Ii,
                APP_STORE_SUBSCRIPTION_CONVERT: O.g.Ji,
                APP_STORE_SUBSCRIPTION_RENEW: O.g.Ki,
                ...
                GTAG_CONFIG: O.g.ba,
                GTAG_GET: O.g.Ya,
                IN_APP_PURCHASE: O.g.Ni,
                PAGE_VIEW: O.g.ac,
                SESSION_START: O.g.Oi,
            ...
            EventParameters: {
                ...
                DC_NATURAL_SEARCH: O.g.dj,
                DEBUG_MODE: O.g.Hg,
                DECORATE_FORMS: O.g.yb,
                DELIVERY_POSTAL_CODE: O.g.ud,
                DEVELOPER_ID: O.g.fa,
                DISABLE_MERCHANT_REPORTED_PURCHASES: O.g.cj,
                DISCOUNT: O.g.Wd,
                ...
                PAGE_PATH: O.g.od,
                PAGE_REFERRER: O.g.Fa,
                PAGE_TITLE: O.g.ib,
                PASSENGERS: O.g.ah,
                PHONE_CONVERSION_CALLBACK: O.g.bh,
                PHONE_CONVERSION_COUNTRY_CODE: O.g.qj,
                PHONE_CONVERSION_CSS_CLASS: O.g.eh,
                PHONE_CONVERSION_IDS: O.g.rj,
    ...
    function BJ(a, b) {
        ...
        ql() && (Xk.delegatedConsentTypes[a] = b);
    }
    ...
    function DJ(a, b, c) {
        ...
        (c || Ol(a) === void 0) && Nl(a, G(b, this.D, 1));
    }
    ...
    KJ.getItem = function(a) {
        ...
        var c = vA(this).kb();
        LJ[c] && (b = LJ[c].hasOwnProperty("gtm." + a) ? LJ[c]["gtm." + a] : null);
        return b
    }
    ;
    ...
    KJ.removeItem = function(a) {
        L(this, "access_template_storage");
        var b = vA(this).kb();
        if (!LJ[b] || !LJ[b].hasOwnProperty("gtm." + a))
            return;
        delete LJ[b]["gtm." + a];
    }
    ;
    ...
    (function(a) {
        ...
        var g = function(v) {
            ...
            pc("https://" + Hi.vf + "/debug/bootstrap?id=" + Pf.ctid + "&src=" + w + "&cond=" + v + "&gtm=" + No()));
            var y = {
                ...
                if (ak().canonical[g]) {
                    ...
                    if (Rj) {
                        ...
                        if (!Uf)
                            ...
                            var jo = go;
                            jo && (Hk("rtg", String(Uf.canonicalContainerId)),
                            Hk("rlo", String(jo.hn)),
                        ...
                        var Iy = ko;
                        Iy && Hk("pcid", Iy);
                        S(34) && (Hk("bt", String(aj.H ? 2 : Qi ? 1 : 0)),
