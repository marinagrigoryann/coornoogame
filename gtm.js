    ...
    var data = {
        "resource": {
            ...
            "macros": [{
                ...
                "vtp_map": ["list", ["map", "key", ".*(themeforest|codecanyon|audiojungle|videohive|3docean|graphicriver|photodune)-staging\\.net", "value", ["macro", 12]], ["map", "key", ".*(themeforest|codecanyon|audiojungle|videohive|3docean|graphicriver|photodune)\\.net", "value", ["macro", 13]]]
            }, {
                "function": "__v",
                "vtp_dataLayerVersion": 2,
                "vtp_setDefaultValue": false,
                ...
                "function": "__gtes",
                "vtp_eventSettingsTable": ["list", ["map", "parameter", "app_name", "parameterValue", ["macro", 15]], ["map", "parameter", "app_env", "parameterValue", ["macro", 16]], ["map", "parameter", "app_version", "parameterValue", ["macro", 17]], ["map", "parameter", "page_type", "parameterValue", ["macro", 18]], ["map", "parameter", "custom_timestamp", "parameterValue", ["macro", 19]], ["map", "parameter", "event_type", "parameterValue", ["macro", 20]], ["map", "parameter", "ga_param", "parameterValue", ["macro", 21]], ["map", "parameter", "user_id", "parameterValue", ["macro", 22]], ["map", "parameter", "page_location", "parameterValue", ["macro", 23]], ["map", "parameter", "page_referrer", "parameterValue", ["macro", 24]], ["map", "parameter", "page_title", "parameterValue", ["macro", 25]]],
            ...
            "tags": [{
                ...
                "vtp_eventSettingsTable": ["list", ["map", "parameter", "context", "parameterValue", ["macro", 1]], ["map", "parameter", "context_detail", "parameterValue", ["macro", 2]], ["map", "parameter", "coupon", "parameterValue", ["macro", 3]], ["map", "parameter", "currency", "parameterValue", ["macro", 4]], ["map", "parameter", "items", "parameterValue", ["macro", 5]], ["map", "parameter", "search_results", "parameterValue", ["macro", 6]], ["map", "parameter", "search_term", "parameterValue", ["macro", 7]], ["map", "parameter", "value", "parameterValue", ["macro", 8]], ["map", "parameter", "quantity_update", "parameterValue", ["macro", 9]]],
                ...
                "vtp_eventSettingsTable": ["list", ["map", "parameter", "click_label", "parameterValue", ["macro", 28]], ["map", "parameter", "click_type", "parameterValue", ["macro", 29]], ["map", "parameter", "context", "parameterValue", ["macro", 1]], ["map", "parameter", "context_detail", "parameterValue", ["macro", 2]], ["map", "parameter", "custom_item_brand", "parameterValue", ["macro", 30]], ["map", "parameter", "custom_item_category", "parameterValue", ["macro", 31]], ["map", "parameter", "custom_item_id", "parameterValue", ["macro", 32]], ["map", "parameter", "custom_item_name", "parameterValue", ["macro", 33]], ["map", "parameter", "download_type", "parameterValue", ["macro", 34]], ["map", "parameter", "filter_type", "parameterValue", ["macro", 35]], ["map", "parameter", "filter_value", "parameterValue", ["macro", 36]], ["map", "parameter", "item_resolution", "parameterValue", ["macro", 37]], ["map", "parameter", "licence_type", "parameterValue", ["macro", 38]], ["map", "parameter", "link_anchor", "parameterValue", ["macro", 39]], ["map", "parameter", "link_domain", "parameterValue", ["macro", 40]], ["map", "parameter", "link_query", "parameterValue", ["macro", 41]], ["map", "parameter", "link_url", "parameterValue", ["macro", 42]], ["map", "parameter", "search_results", "parameterValue", ["macro", 6]], ["map", "parameter", "search_term", "parameterValue", ["macro", 7]]],
                "vtp_enhancedUserId": false,
                "vtp_eventName": ["macro", 10],
                "vtp_measurementIdOverride": ["macro", 14],
                "vtp_eventSettingsVariable": ["macro", 27],
...
*/
    ...
    Hi.Ce = Number("0") || 0;
    Hi.ob = "dataLayer";
    Hi.Cn = "ChAIgIq3uQYQkKirgr6ygqkOEiQAu4ow181GUJZV0kdGA3WMHsYCyc7sLBJGwA96insNHKEPx3YaAhwA";
    var Ji = {
        __cl: 1,
        __ecl: 1,
        __ehl: 1,
    ...
    ;function dA() {
        var a = [["cv", S(114) ? cA() : "9"], ["rv", Hi.th], ["tc", lf.filter(function(b) {
            return b
        }).length]];
    ...
    h.isActive = function(a, b) {
        ...
        if (!c)
            return !0;
        if (!this.isActive([c.fi], b))
            return !1;
        for (var e = 0; e < c.rf.length; e++)
            if (this.C[c.rf[e]].Gd(b))
                return !0;
        return !1
    }
    ;
    ...
    function xB(a, b) {
        ...
        var e = function(v) {
            Ow(v, function(t) {
                for (var w = Pw().getExternalRestrictions(0, nk()), x = l(w), y = x.next(); !y.done; y = x.next()) {
                    var A = y.value;
                    if (!A(t))
                        return !1
                }
            ...
            Qw(v, function(t) {
                for (var w = Pw().getExternalRestrictions(1, nk()), x = l(w), y = x.next(); !y.done; y = x.next()) {
                    var A = y.value;
                    if (!A(t))
                        return !1
                }
        ...
        k && r.kb() === "__zone" && qB(Number.MIN_SAFE_INTEGER, [a], null, {}, lB(vA(this)));
        d = p ? jk(a) : a;
        return d
    }
    ...
    function() {
        ...
        function b(f, g, k) {
            var m = {}, n = function(v, t) {
                ...
                if (v) {
                    ...
                    y++)
                        ...
                        jb(v[y], function(B) {
                            return function(D, I) {
                                w && D === "id" ? B.ef.promotion_id = I : w && D === "name" ? B.ef.promotion_name = I : B.ef[D] = I
                            }
                        }(x)),
                        m.items.push(x.ef)
                }
                if (t)
                    for (var A in t)
                        d.hasOwnProperty(A) ? n(d[A], t[A]) : n(A, t[A])
            }, q;
            ...
            if (Uc(q)) {
                var r = !1, u;
                for (u in q)
                    q.hasOwnProperty(u) && (r || (c.push(5),
                    r = !0),
                    u === "currencyCode" ? n("currency", q.currencyCode) : u === "impressions" && g === O.g.pb ? p(q.impressions, null) : u === "promoClick" && g === O.g.Kb ? p(q.promoClick.promotions, q.promoClick.actionField, !0) : u === "promoView" && g === O.g.qb ? p(q.promoView.promotions, q.promoView.actionField, !0) : e.hasOwnProperty(u) ? g === e[u] && p(q[u].products, q[u].actionField) : m[u] = q[u]);
                $J(m, k)
            }
        }
        var c = []
        ...
        (function(f) {
            ...
            if (z(g) && g.indexOf("G-") === 0) {
                var k = String(f.vtp_eventName)
                  , m = {};
                c = [];
                f.vtp_sendEcommerceData && (sh.hasOwnProperty(k) || k === "checkout_option") && b(f, k, m);
                var n = f.vtp_eventSettingsVariable;
                if (n)
                    for (var p in n)
                        n.hasOwnProperty(p) && (m[p] = n[p]);
                if (f.vtp_eventSettingsTable) {
                    var q = cK(f.vtp_eventSettingsTable, "parameter", "parameterValue"), r;
                    for (r in q)
                        m[r] = q[r]
                }
                var u = cK(f.vtp_eventParameters, "name", "value"), v;
                for (v in u)
                    u.hasOwnProperty(v) && (m[v] = u[v]);
